...
![The Waterman Butterfly](~/waterman.webp)
...
![What Greenland would look like on the Mercator if it was closer to the equator.](~/mercator_greenland.webp)
...
![The true size of Greenland](~/waterman_countries.webp)
...
![The curved path is shorter than the straight path.](~/shortest_distance_on_map.webp)
...
![The problem with split projections](~/xkcd_sea_chase.webp)

### Relative North

Almost every map projection sets North as being in the upwards direction. It looks odd otherwise.

![Maps looks weird upside down](~/flipped_map.webp)
...
![North pole is on the wingtips](~/waterman_tissot.webp)
...
![A Waterman poster](~/waterman_poster.webp)
...
![Lasercut Waterman](~/waterman_lasercut.webp)
