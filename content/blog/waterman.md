...
![The Waterman Butterfly](/media/waterman.webp)
...
![What Greenland would look like on the Mercator if it was closer to the equator.](/media/mercator_greenland.webp)
...
![The true size of Greenland](/media/waterman_countries.webp)
...
![The curved path is shorter than the straight path.](/media/shortest_distance_on_map.webp)
...
![The problem with split projections](/media/xkcd_sea_chase.webp)

### Relative North

Almost every map projection sets North as being in the upwards direction. It looks odd otherwise.

![Maps looks weird upside down](/media/flipped_map.webp)
...
![North pole is on the wingtips](/media/waterman_tissot.webp)
...
![A Waterman poster](/media/waterman_poster.webp)
...
![Lasercut Waterman](/media/waterman_lasercut.webp)
